const PrivacyPolicy = () => {
    return (
        <div style={{ float: "left" }}>
            ...
            <p style={{ fontSize: "22px" }}>Son güncellenme: 21/08/2023</p>
            <p style={{ fontSize: "22px" }}>
                Güvenliğiniz bizim için önemli. Bu sebeple bizimle paylaşacağınız kişisel verileriz hassasiyetle korunmaktadır.
            </p>
            <p style={{ fontSize: "22px" }}>
                Biz, Ulker Software, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile,
            ...
            <p style={{ fontSize: "22px" }}>KVKK madde 11 uyarınca herkes, veri sorumlusuna başvurarak aşağıdaki haklarını kullanabilir:</p>
