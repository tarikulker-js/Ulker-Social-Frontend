    ...
    return (
        <div style={{ float: "left" }}>
            ...
            <p style={{ fontSize: "22px" }}>
                Biz, Ulker Software, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz
            ...
            <p style={{ fontSize: "22px" }}>
                ...
                göz atabilir ya da bizlerle tarik@ulkersoft.com.tr e-mail adresi üzerinden iletişime geçebilirsiniz.
            </p>
        </div>
    )
}
