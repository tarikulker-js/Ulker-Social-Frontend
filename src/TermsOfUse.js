    ...
    return (
        <div style={{ float: "left" }}>
            ...
            <p style={{ fontSize: "22px" }}>
                Sevgili ziyaretçimiz, lütfen ulkersoft.com.tr web sitemizi ziyaret etmeden önce işbu
            ...
            <p style={{ fontSize: "22px" }}>
                ulkersoft.com.tr web sitesi Ulker Software tarafından yönetilmekte olup, bundan sonra SİTE olarak anılacaktır.
            ...
            <p style={{ fontSize: "22px" }}>
                Ulker Software olarak, sunacağımız hizmetlerin kapsamını ve niteliğini, yasalar
            ...
            <p style={{ fontSize: "22px" }}>
                ...
                (bundan böyle ve daha sonra "içerik" olarak anılacaktır) Ulker Software olup,
